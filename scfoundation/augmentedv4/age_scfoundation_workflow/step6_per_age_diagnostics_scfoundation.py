#!/usr/bin/env python3
"""
STEP 6 — Per-Age Fairness Diagnostics (AGE, scFoundation)
...
Changes vs sex version:
  ...
  [AGE 4] Reference baseline -> Proportional_2495
...
BASE = pathlib.Path(
    "/oscar/home/fperalta/data/fperalta/scfoundation/augmentedv4/age_scfoundation_workflow"
)

LABELED_DIR = BASE / "step3b_labeled"
OUTDIR      = BASE / "step6_outputs_age_scfoundation"             # [AGE 5]
OUTDIR.mkdir(exist_ok=True)

OUTPUT_BASE = "ILD_Age_Pilot"                                   # [AGE 1]
...
def main():
    ...
    if "Proportional_2495" not in datasets:                    # [AGE 4]
    ...
    out_csv = OUTDIR / "step6_per_age_diagnostics_scfoundation.csv"
    pivot.to_csv(out_csv)
    log(f"\nCSV saved -> {out_csv}")

    out_txt = OUTDIR / "step6_per_age_diagnostics_report_scfoundation.txt"
    lines = [
