#!/usr/bin/env python3
"""STEP 3a — scIB Benchmarking (AGE, scFoundation)"""
import os
...
DATASETS = {
    "Proportional_2495":          f"{OUTPUT_BASE}_Proportional_2495_AGE_scfoundation.h5ad",
    "BalancedAugmented_1262Each": f"{OUTPUT_BASE}_BalancedAugmented_1262Each_AGE_scfoundation.h5ad",
    "BalancedUpsampled_1262Each": f"{OUTPUT_BASE}_BalancedUpsampled_1262Each_AGE_scfoundation.h5ad",
    "Downsampled_25Each":         f"{OUTPUT_BASE}_Downsampled_25Each_AGE_scfoundation.h5ad",
}
