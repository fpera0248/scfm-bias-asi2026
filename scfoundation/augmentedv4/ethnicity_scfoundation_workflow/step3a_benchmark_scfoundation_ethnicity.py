...
DATASETS = {
    "BalancedAugmented_2143Each": f"{OUTPUT_BASE}_BalancedAugmented_2143Each_ETHNICITY_scfoundation.h5ad",
    "Proportional_2497":          f"{OUTPUT_BASE}_Proportional_2497_ETHNICITY_scfoundation.h5ad",
    "BalancedUpsampled_2143Each": f"{OUTPUT_BASE}_BalancedUpsampled_2143Each_ETHNICITY_scfoundation.h5ad",
    "Downsampled_48Each":         f"{OUTPUT_BASE}_Downsampled_48Each_ETHNICITY_scfoundation.h5ad",
}
