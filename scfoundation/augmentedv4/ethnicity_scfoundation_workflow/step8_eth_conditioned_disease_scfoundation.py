#!/usr/bin/env python3
"""STEP 8 — Ethnicity-Conditioned Disease Prediction (ETHNICITY, scFoundation)"""
...
UNDERREP_GROUP = "native american"; MIN_SAMPLES = 2; TEST_SIZE = 0.20; RANDOM_STATE = 42
...
def main():
    log("="*70); log("STEP 8 -- Ethnicity-Conditioned Disease Prediction (ETHNICITY, scFoundation)"); log("="*70)
    all_dfs = []
    ...
    lines = ["STEP 8 -- ETHNICITY-CONDITIONED DISEASE PREDICTION (ETHNICITY, scFoundation)", "="*70, "",
