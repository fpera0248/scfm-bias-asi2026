#!/usr/bin/env python3
"""STEP 3a — scIB Benchmarking (CRC ETHNICITY, scFoundation)"""
...
DATASETS = {
    "BalancedAugmented_1880Each": f"{OUTPUT_BASE}_BalancedAugmented_1880Each_ETH_scfoundation.h5ad",
    "Proportional_2497":          f"{OUTPUT_BASE}_Proportional_2497_ETH_scfoundation.h5ad",
    "BalancedUpsampled_1880Each": f"{OUTPUT_BASE}_BalancedUpsampled_1880Each_ETH_scfoundation.h5ad",
    "Downsampled_48Each":         f"{OUTPUT_BASE}_Downsampled_48Each_ETH_scfoundation.h5ad",
}
...
def run_scib(mode, fname):
    path = BASE / "step2a_embeddings" / fname
...
def main():
    ...
    print(f"\n{'='*70}\nSTEP 3a COMPLETE (CRC ETHNICITY, scFoundation)\n\n" + df.to_string(index=False))
