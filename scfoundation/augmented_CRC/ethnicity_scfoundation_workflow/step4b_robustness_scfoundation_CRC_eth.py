#!/usr/bin/env python3
"""STEP 4b — Robustness Stress Test (CRC ETHNICITY, scFoundation)"""
...
logger.info("========== STEP 4b START (CRC ETHNICITY, scFoundation) ==========")
...
logger.info(f"========== STEP 4b COMPLETE (CRC ETHNICITY, scFoundation) ==========  Runtime: {total_min:.2f} min")
