#!/usr/bin/env python3
"""
STEP 6 — Per-Age Fairness Diagnostics (CRC AGE, scFoundation)
...
def main():
    log("=" * 70)
    log("STEP 6 -- Per-Age Fairness Diagnostics (CRC AGE, scFoundation)")  # [AGE 5]
    log("=" * 70)
    ...
    lines = [
        ...
        "KNN MIXING: with 5 age bins, random expected ~0.800 (4/5 neighbours from other bins).",
