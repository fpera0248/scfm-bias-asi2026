...
BASE   = pathlib.Path("/oscar/home/fperalta/data/fperalta/scfoundation/augmented_CRC/age_scfoundation_workflow")
...
DATASETS = {
    "Proportional_2498":          (BASE / f"{OUTPUT_BASE}_Proportional_2498_AGE.h5ad",          f"{OUTPUT_BASE}_Proportional_2498_AGE_scfoundation.h5ad"),
    "BalancedAugmented_650Each":  (BASE / f"{OUTPUT_BASE}_BalancedAugmented_650Each_AGE.h5ad",  f"{OUTPUT_BASE}_BalancedAugmented_650Each_AGE_scfoundation.h5ad"),
    "BalancedUpsampled_650Each":  (BASE / f"{OUTPUT_BASE}_BalancedUpsampled_650Each_AGE.h5ad",  f"{OUTPUT_BASE}_BalancedUpsampled_650Each_AGE_scfoundation.h5ad"),
    "Downsampled_124Each":         (BASE / f"{OUTPUT_BASE}_Downsampled_124Each_AGE.h5ad",          f"{OUTPUT_BASE}_Downsampled_124Each_AGE_scfoundation.h5ad"),
    "ExternalValidation_9402":    (BASE / "CRC_Age_External_Validation_9402.h5ad",               "CRC_Age_External_Validation_9402_scfoundation.h5ad"),
}
...
log("STEP 2a CRC AGE scFoundation COMPLETE")
