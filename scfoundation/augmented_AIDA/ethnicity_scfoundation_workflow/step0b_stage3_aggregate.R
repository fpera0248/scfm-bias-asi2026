...
# CONFIG
INPUT_H5AD   <- "AIDA_RawCounts_ETHNICITY_900k.h5ad"
...
src_counts <- as(assay(sce_full, ASSAY_USE), "dgCMatrix")
...
out_prop <- paste0(OUTPUT_BASE, "_Proportional_2500_ETHNICITY.h5ad")
...
out_down <- paste0(OUTPUT_BASE, "_Downsampled_92Each_ETHNICITY.h5ad")
