...
Changes vs sex version:
  ...
  [ETH 4] VALIDATION    -> AIDA_Ethnicity_External_Validation_12500
...
DATASETS = {                                                                        # [ETH 3]
    "Proportional_2500": (
        ...
        f"{OUTPUT_BASE}_Proportional_2500_ETHNICITY_scfoundation.h5ad",
    ),
    "BalancedAugmented_779Each": (
        f"{OUTPUT_BASE}_BalancedAugmented_779Each_ETHNICITY.h5ad",
        f"{OUTPUT_BASE}_BalancedAugmented_779Each_ETHNICITY_scfoundation.h5ad",
    ),
    "BalancedUpsampled_779Each": (
        f"{OUTPUT_BASE}_BalancedUpsampled_779Each_ETHNICITY.h5ad",
        f"{OUTPUT_BASE}_BalancedUpsampled_779Each_ETHNICITY_scfoundation.h5ad",
    ),
    "Downsampled_92Each": (
        f"{OUTPUT_BASE}_Downsampled_92Each_ETHNICITY.h5ad",
        f"{OUTPUT_BASE}_Downsampled_92Each_ETHNICITY_scfoundation.h5ad",
    ),
    "ExternalValidation_12500": (                                                   # [ETH 4]
        "AIDA_Ethnicity_External_Validation_12500.h5ad",
        "AIDA_Ethnicity_External_Validation_12500_scfoundation.h5ad",
    ),
}
