#!/usr/bin/env python3
"""STEP 6 — Per-Ethnicity Fairness Diagnostics (ETHNICITY, scFoundation)"""
...
def main():
    log("="*70); log("STEP 6 -- Per-Ethnicity Fairness Diagnostics (ETHNICITY, scFoundation)"); log("="*70)
    datasets = {}
    ...
    lines = ["STEP 6 -- PER-ETHNICITY FAIRNESS DIAGNOSTICS (ETHNICITY, scFoundation)", "="*70, "",
