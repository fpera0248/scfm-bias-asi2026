#!/usr/bin/env python3
"""STEP 4a — Downstream Disease Prediction (ETHNICITY, scFoundation)"""
...
BASE   = Path("/oscar/home/fperalta/data/fperalta/scfoundation/augmented_AIDA/ethnicity_scfoundation_workflow")
...
OUTPUT_BASE = "AIDA_Ethnicity_Pilot"; LABELED_DIR = BASE / "step3b_labeled"
DATASETS = {
...
def main():
    ...
    with open(OUTFILE_TXT, "w") as fh:
        fh.write("STEP 4a -- Downstream Disease Prediction (ETHNICITY, scFoundation)\n" + "="*80 + "\n")
