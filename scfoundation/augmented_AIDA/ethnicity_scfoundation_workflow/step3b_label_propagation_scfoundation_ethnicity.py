#!/usr/bin/env python3
"""STEP 3b — kNN Disease Label Propagation (ETHNICITY, scFoundation)"""
...
DATASETS = {
    "BalancedAugmented_2143Each": BASE / f"{OUTPUT_BASE}_BalancedAugmented_2143Each_ETHNICITY_scfoundation.h5ad",
    "Proportional_2497":          BASE / f"{OUTPUT_BASE}_Proportional_2497_ETHNICITY_scfoundation.h5ad",
    "BalancedUpsampled_2143Each": BASE / f"{OUTPUT_BASE}_BalancedUpsampled_2143Each_ETHNICITY_scfoundation.h5ad",
    "Downsampled_48Each":         BASE / f"{OUTPUT_BASE}_Downsampled_48Each_ETHNICITY_scfoundation.h5ad",
}
...
def main():
    ...
    log("="*70); log("STEP 3b -- kNN Disease Label Propagation (ETHNICITY, scFoundation)"); log("="*70)
    summary_rows = []
    ...
    log(f"\n{'='*70}\nSTEP 3b COMPLETE (ETHNICITY, scFoundation)")
