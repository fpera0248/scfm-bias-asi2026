#!/usr/bin/env python3
"""STEP 4 -- External Validation Disease + Cell-Type Classification (ETHNICITY, scFoundation)"""
...
VALIDATION_FILE = BASE / "AIDA_Ethnicity_External_Validation_12500_scfoundation.h5ad"
...
def main():
    ...
    log("="*70); log("STEP 4 -- External Validation Classification (ETHNICITY, scFoundation)"); log("="*70)
    ...
    log(f"\n{'='*70}\nSTEP 4 COMPLETE (ETHNICITY, scFoundation)")
