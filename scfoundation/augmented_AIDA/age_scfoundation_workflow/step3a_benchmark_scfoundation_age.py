...
DATASETS = {
    ...
    "BalancedAugmented_747Each": f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE_scfoundation.h5ad",
    "BalancedUpsampled_747Each": f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE_scfoundation.h5ad",
    "Downsampled_230Each":         f"{OUTPUT_BASE}_Downsampled_230Each_AGE_scfoundation.h5ad",
}
