...
Changes vs sex version:
  ...
  [AGE 4] VALIDATION     -> AIDA_Age_External_Validation_10000.h5ad
...
BASE   = pathlib.Path("/oscar/home/fperalta/data/fperalta/scfoundation/augmented_AIDA/age_scfoundation_workflow")  # [AGE 1]
INDIR  = BASE
...
DATASETS = {                                                                                                     # [AGE 3]
    "Proportional_2498": (
        BASE / f"{OUTPUT_BASE}_Proportional_2498_AGE.h5ad",
        f"{OUTPUT_BASE}_Proportional_2498_AGE_scfoundation.h5ad",
    ),
    "BalancedAugmented_747Each": (
        BASE / f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE.h5ad",
        f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE_scfoundation.h5ad",
    ),
    "BalancedUpsampled_747Each": (
        BASE / f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE.h5ad",
        f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE_scfoundation.h5ad",
    ),
    "Downsampled_230Each": (
        BASE / f"{OUTPUT_BASE}_Downsampled_230Each_AGE.h5ad",
        f"{OUTPUT_BASE}_Downsampled_230Each_AGE_scfoundation.h5ad",
    ),
    "ExternalValidation_10000": (                                                                                # [AGE 4]
        BASE / "AIDA_Age_External_Validation_10000.h5ad",
        "AIDA_Age_External_Validation_10000_scfoundation.h5ad",
    ),
}
