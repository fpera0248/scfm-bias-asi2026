...
DATASETS = {
    "BalancedAugmented_747Each": EMBDIR / f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE_scfoundation.h5ad",
    "Proportional_2498":          EMBDIR / f"{OUTPUT_BASE}_Proportional_2498_AGE_scfoundation.h5ad",
    "BalancedUpsampled_747Each": EMBDIR / f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE_scfoundation.h5ad",
    "Downsampled_230Each":         EMBDIR / f"{OUTPUT_BASE}_Downsampled_230Each_AGE_scfoundation.h5ad",
}
