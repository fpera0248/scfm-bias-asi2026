...
FILES = {
    "Proportional_2497":          ETH_DIR / "ILD_Ethnicity_Pilot_Proportional_2497_ETHNICITY.h5ad",
    "BalancedAugmented_2143Each": ETH_DIR / "ILD_Ethnicity_Pilot_BalancedAugmented_2143Each_ETHNICITY.h5ad",
    "BalancedUpsampled_2143Each": ETH_DIR / "ILD_Ethnicity_Pilot_BalancedUpsampled_2143Each_ETHNICITY.h5ad",
    "Downsampled_48Each":         ETH_DIR / "ILD_Ethnicity_Pilot_Downsampled_48Each_ETHNICITY.h5ad",
}

VALIDATION_FILE = ETH_DIR / "ILD_Ethnicity_External_Validation_12500.h5ad"
...
def main():
    ...
    for label, path in FILES.items():
        ...
        out_path = OUTDIR / f"ILD_Ethnicity_Pilot_{label}_scgpt.h5ad"
    ...
    val_path = OUTDIR / "ILD_Ethnicity_External_Validation_12500_scgpt.h5ad"
