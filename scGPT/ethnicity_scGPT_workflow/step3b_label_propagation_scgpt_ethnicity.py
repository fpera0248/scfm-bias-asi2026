#!/usr/bin/env python3
"""
STEP 3b — kNN Disease Label Propagation (ETHNICITY, scGPT)
...
BASE   = Path("/oscar/home/fperalta/data/fperalta/scGPT/ethnicity_scGPT_workflow")
...
DATASETS = {                                                     # [SCGPT 4]
    "BalancedAugmented_2143Each": INDIR / f"{OUTPUT_BASE}_BalancedAugmented_2143Each_scgpt.h5ad",
    "Proportional_2497":          INDIR / f"{OUTPUT_BASE}_Proportional_2497_scgpt.h5ad",
    "BalancedUpsampled_2143Each": INDIR / f"{OUTPUT_BASE}_BalancedUpsampled_2143Each_scgpt.h5ad",
    "Downsampled_48Each":         INDIR / f"{OUTPUT_BASE}_Downsampled_48Each_scgpt.h5ad",
}
...
def main():
    ...
    log("=" * 70)
    log("STEP 3b -- kNN Disease Label Propagation (ETHNICITY, scGPT)")
    log("=" * 70)
    log(f"KNN_K       = {KNN_K}")
    ...
    log(f"\n{'='*70}")
    log("STEP 3b COMPLETE (ETHNICITY, scGPT)")
