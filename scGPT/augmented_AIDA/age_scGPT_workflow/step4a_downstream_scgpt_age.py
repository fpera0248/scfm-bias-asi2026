...
OUTDIR = BASE / "step4a_downstream_scgpt_age"
...
DATASETS = {
    ...
    "BalancedUpsampled_747Each": LABELED_DIR / f"{OUTPUT_BASE}_BalancedUpsampled_747Each_labeled_scgpt.h5ad",
    "Downsampled_230Each":        LABELED_DIR / f"{OUTPUT_BASE}_Downsampled_230Each_labeled_scgpt.h5ad",
}
...
def main():
    ...
    with open(OUTFILE_TXT, "w") as fh:
        fh.write("STEP 4a -- Downstream Disease Prediction (AGE, scGPT)\n" + "="*80 + "\n")
