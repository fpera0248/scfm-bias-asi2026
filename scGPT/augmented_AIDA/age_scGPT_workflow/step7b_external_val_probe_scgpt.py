#!/usr/bin/env python3
"""
STEP 7b -- External validation probe (scGPT, AGE)
...
CELL_KEY = "cell_type"
OUT_DIR = BASE / "step7b_external_val_scgpt"
OUT_DIR.mkdir(exist_ok=True)

VAL_FILE = EMB_DIR / "AIDA_Age_External_Validation_10000_scgpt.h5ad"

FILES = {
    "Proportional_2498":         EMB_DIR / f"{OUTPUT_BASE}_Proportional_2498_AGE_scgpt.h5ad",
    "BalancedAugmented_747Each": EMB_DIR / f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE_scgpt.h5ad",
    "BalancedUpsampled_747Each": EMB_DIR / f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE_scgpt.h5ad",
    "Downsampled_230Each":       EMB_DIR / f"{OUTPUT_BASE}_Downsampled_230Each_AGE_scgpt.h5ad",
}
...
def main():
    log("=" * 70)
    log("STEP 7b -- External validation probe (scGPT, AGE)")
    log("=" * 70)
