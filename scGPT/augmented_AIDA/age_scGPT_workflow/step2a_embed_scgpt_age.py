...
Changes vs sex scGPT version:
  ...
  [AGE 3] RAW_COUNTS     -> AIDA_RawCounts_AGE.h5ad
  [AGE 4] DATASETS       -> age filenames (747Each, 230Each, 2495)
  [AGE 5] VALIDATION     -> AIDA_Age_External_Validation_10000.h5ad
...
RAW_COUNTS_PATH = BASE / "AIDA_RawCounts_AGE.h5ad"   # [AGE 3]

OUTPUT_BASE = "AIDA_Age_Pilot"

DATASETS = {                                                                    # [AGE 4]
    "Proportional_2498":          BASE / f"{OUTPUT_BASE}_Proportional_2498_AGE.h5ad",
    "BalancedAugmented_747Each": BASE / f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE.h5ad",
    "BalancedUpsampled_747Each": BASE / f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE.h5ad",
    "Downsampled_230Each":         BASE / f"{OUTPUT_BASE}_Downsampled_230Each_AGE.h5ad",
    "ExternalValidation_10000":   BASE / "AIDA_Age_External_Validation_10000.h5ad",          # [AGE 5]
}

OUTPUT_NAMES = {
    "Proportional_2498":          f"{OUTPUT_BASE}_Proportional_2498_AGE_scgpt.h5ad",
    "BalancedAugmented_747Each": f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE_scgpt.h5ad",
    "BalancedUpsampled_747Each": f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE_scgpt.h5ad",
    "Downsampled_230Each":         f"{OUTPUT_BASE}_Downsampled_230Each_AGE_scgpt.h5ad",
    "ExternalValidation_10000":   "AIDA_Age_External_Validation_10000_scgpt.h5ad",
}
