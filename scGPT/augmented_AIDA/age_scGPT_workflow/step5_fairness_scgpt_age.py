...
OUTDIR      = BASE / "step5_outputs_age_scgpt"              # [AGE 4]
...
def plot_learning_curves(lc_df, outdir):
    ...
    plt.tight_layout()
    out = outdir / "step5_learning_curves_age_scgpt.png"
...
out_txt = OUTDIR / "step5_fairness_stress_test_age_scgpt.txt"
out_txt.write_text("\n".join(report_lines))
log(f"\nReport  -> {out_txt}")

out_csv = OUTDIR / "step5_summary_age_scgpt.csv"
...
if all_lc_rows:
    ...
    if lc_nonempty:
        ...
        out_lc_csv = OUTDIR / "step5_learning_curves_age_scgpt.csv"
