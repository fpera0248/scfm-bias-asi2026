#!/usr/bin/env python3
"""
STEP 8 — Ethnicity-Conditioned Disease Prediction (ETHNICITY, scGPT)
...
Changes vs Geneformer ethnicity version:
  ...
  [SCGPT 5] Reference      -> Proportional_2500
"""
...
def main():
    log("="*70)
    log("STEP 8 -- Ethnicity-Conditioned Disease Prediction (ETHNICITY, scGPT)")
    log("="*70)
