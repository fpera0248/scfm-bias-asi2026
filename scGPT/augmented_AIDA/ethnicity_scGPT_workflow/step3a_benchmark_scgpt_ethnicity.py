...
DATASETS = {                                                     # [SCGPT 4]
    "BalancedAugmented_779Each": f"{OUTPUT_BASE}_BalancedAugmented_779Each_scgpt.h5ad",
    "Proportional_2500":          f"{OUTPUT_BASE}_Proportional_2500_scgpt.h5ad",
    "BalancedUpsampled_779Each": f"{OUTPUT_BASE}_BalancedUpsampled_779Each_scgpt.h5ad",
    "Downsampled_92Each":         f"{OUTPUT_BASE}_Downsampled_92Each_scgpt.h5ad",
}
