#!/usr/bin/env python3
"""
Step 7b -- External validation probe (scGPT)
...
VAL_FILE = EMB_DIR / "AIDA_Ethnicity_External_Validation_12500_scgpt.h5ad"

FILES = {
    "Proportional_2500":         EMB_DIR / f"{OUTPUT_BASE}_Proportional_2500_scgpt.h5ad",
    "BalancedAugmented_779Each": EMB_DIR / f"{OUTPUT_BASE}_BalancedAugmented_779Each_scgpt.h5ad",
    "BalancedUpsampled_779Each": EMB_DIR / f"{OUTPUT_BASE}_BalancedUpsampled_779Each_scgpt.h5ad",
    "Downsampled_92Each":        EMB_DIR / f"{OUTPUT_BASE}_Downsampled_92Each_scgpt.h5ad",
}
...
def main():
    log("=" * 70)
    log("STEP 7b -- External validation probe (scGPT)")
    log("=" * 70)
