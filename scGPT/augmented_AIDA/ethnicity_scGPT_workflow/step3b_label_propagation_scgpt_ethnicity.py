...
Changes vs Geneformer ethnicity version:
  [SCGPT 1] BASE path  -> scGPT/augmented_AIDA/ethnicity_scGPT_workflow
...
DATASETS = {                                                     # [SCGPT 4]
    "BalancedAugmented_779Each": INDIR / f"{OUTPUT_BASE}_BalancedAugmented_779Each_scgpt.h5ad",
    "Proportional_2500":          INDIR / f"{OUTPUT_BASE}_Proportional_2500_scgpt.h5ad",
    "BalancedUpsampled_779Each": INDIR / f"{OUTPUT_BASE}_BalancedUpsampled_779Each_scgpt.h5ad",
    "Downsampled_92Each":         INDIR / f"{OUTPUT_BASE}_Downsampled_92Each_scgpt.h5ad",
}
