#!/usr/bin/env python3
"""
STEP 4 -- External Validation Disease + Cell-Type Classification (ETHNICITY, scGPT)
...
Changes vs Geneformer ethnicity version:
  ...
  [SCGPT 5] VALIDATION_FILE -> AIDA_Ethnicity_External_Validation_12500_scgpt.h5ad
...
VALIDATION_FILE = BASE / "step2a_embeddings" / "AIDA_Ethnicity_External_Validation_12500_scgpt.h5ad"  # [SCGPT 5]
...
def main():
    ...
    log("=" * 70)
    log("STEP 4 -- External Validation Classification (ETHNICITY, scGPT)")
    log("=" * 70)
    ...
    log(f"\n{'='*70}")
    log(f"STEP 4 COMPLETE (ETHNICITY, scGPT)")
