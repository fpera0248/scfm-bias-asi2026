#!/usr/bin/env python3
"""
STEP 4b — Robustness Stress Test (CRC ETHNICITY, scGPT)
...
OUTDIR = BASE / "step4b_model_robustness_tests_scgpt"
OUTDIR.mkdir(exist_ok=True)

CSV_FILE = OUTDIR / "step4b_results_ethnicity_labeled_scgpt.csv"
TXT_FILE = OUTDIR / "step4b_full_log_ethnicity_labeled_scgpt.txt"

logger = logging.getLogger("STEP4B_ETH_SCGPT")
...
logger.info("========== STEP 4b START (CRC ETHNICITY, scGPT) ==========")
...
logger.info("========== STEP 4b COMPLETE (CRC ETHNICITY, scGPT) ==========")
