...
DATASETS = {
    ...
    "BalancedAugmented_650Each":  BASE / f"{OUTPUT_BASE}_BalancedAugmented_650Each_AGE.h5ad",
    "BalancedUpsampled_650Each":  BASE / f"{OUTPUT_BASE}_BalancedUpsampled_650Each_AGE.h5ad",
    "Downsampled_124Each":         BASE / f"{OUTPUT_BASE}_Downsampled_124Each_AGE.h5ad",
    "ExternalValidation_9402":    BASE / "CRC_Age_External_Validation_9402.h5ad",
}
OUTPUT_NAMES = {
    "Proportional_2498":          f"{OUTPUT_BASE}_Proportional_2498_AGE_scgpt.h5ad",
    "BalancedAugmented_650Each":  f"{OUTPUT_BASE}_BalancedAugmented_650Each_AGE_scgpt.h5ad",
    "BalancedUpsampled_650Each":  f"{OUTPUT_BASE}_BalancedUpsampled_650Each_AGE_scgpt.h5ad",
    "Downsampled_124Each":         f"{OUTPUT_BASE}_Downsampled_124Each_AGE_scgpt.h5ad",
    "ExternalValidation_9402":    "CRC_Age_External_Validation_9402_scgpt.h5ad",
}
...
def main():
    ...
    log("\nSTEP 2a CRC AGE scGPT COMPLETE")
