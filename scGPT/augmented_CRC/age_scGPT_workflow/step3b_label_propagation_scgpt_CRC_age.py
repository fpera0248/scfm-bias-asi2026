#!/usr/bin/env python3
"""STEP 3b — kNN Disease Label Propagation (CRC AGE, scGPT)"""
...
DATASETS = {
    "BalancedAugmented_650Each": EMBDIR / f"{OUTPUT_BASE}_BalancedAugmented_650Each_AGE_scgpt.h5ad",
    "Proportional_2498":          EMBDIR / f"{OUTPUT_BASE}_Proportional_2498_AGE_scgpt.h5ad",
    "BalancedUpsampled_650Each": EMBDIR / f"{OUTPUT_BASE}_BalancedUpsampled_650Each_AGE_scgpt.h5ad",
    "Downsampled_124Each":         EMBDIR / f"{OUTPUT_BASE}_Downsampled_124Each_AGE_scgpt.h5ad",
}
...
def main():
    ...
    log("=" * 70)
    log("STEP 3b -- kNN Disease Label Propagation (CRC AGE, scGPT)")
    log("=" * 70)
    log(f"KNN_K      = {KNN_K}")
    ...
    log(f"\n{'='*70}")
    log("STEP 3b COMPLETE (CRC AGE, scGPT)")
