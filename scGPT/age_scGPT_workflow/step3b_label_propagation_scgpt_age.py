#!/usr/bin/env python3
"""STEP 3b — kNN Disease Label Propagation (AGE, scGPT)"""
...
DATASETS = {
    "BalancedAugmented_1262Each": EMBDIR / f"{OUTPUT_BASE}_BalancedAugmented_1262Each_AGE_scgpt.h5ad",
    "Proportional_2495":          EMBDIR / f"{OUTPUT_BASE}_Proportional_2495_AGE_scgpt.h5ad",
    "BalancedUpsampled_1262Each": EMBDIR / f"{OUTPUT_BASE}_BalancedUpsampled_1262Each_AGE_scgpt.h5ad",
    "Downsampled_25Each":         EMBDIR / f"{OUTPUT_BASE}_Downsampled_25Each_AGE_scgpt.h5ad",
}
...
def main():
    ...
    log("=" * 70)
    log("STEP 3b -- kNN Disease Label Propagation (AGE, scGPT)")
    log("=" * 70)
    log(f"KNN_K      = {KNN_K}")
    ...
    log(f"\n{'='*70}")
    log("STEP 3b COMPLETE (AGE, scGPT)")
