...
#   [AGE 4]  OUTPUT_BASE  : ILD_Ethnicity_Pilot -> ILD_Age_Pilot
...
#   [V5 1]  VALIDATION_H5AD constant: ILD_Age_External_Validation_10500.h5ad
...
INPUT_H5AD      <- "InterstitialLungDisease_RawCounts_AGE.h5ad"   # [AGE 3]
VALIDATION_H5AD <- "ILD_Age_External_Validation_10500.h5ad"       # [V5 1]
OUTPUT_BASE     <- "ILD_Age_Pilot"                                 # [AGE 4]
