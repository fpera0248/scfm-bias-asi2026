#!/usr/bin/env python3
"""STEP 3b — kNN Disease Label Propagation (AGE, Geneformer V2-316M)"""
...
DATASETS = {
    "BalancedAugmented_1262Each": BASE / f"{OUTPUT_BASE}_BalancedAugmented_1262Each_AGE_geneformer.h5ad",
    "Proportional_2495":          BASE / f"{OUTPUT_BASE}_Proportional_2495_AGE_geneformer.h5ad",
    "BalancedUpsampled_1262Each": BASE / f"{OUTPUT_BASE}_BalancedUpsampled_1262Each_AGE_geneformer.h5ad",
    "Downsampled_25Each":         BASE / f"{OUTPUT_BASE}_Downsampled_25Each_AGE_geneformer.h5ad",
}
...
def main():
    ...
    log("=" * 70)
    log("STEP 3b -- kNN Disease Label Propagation (AGE, Geneformer)")
    log("=" * 70)
    log(f"KNN_K      = {KNN_K}")
    ...
    log(f"\n{'='*70}")
    log("STEP 3b COMPLETE (AGE, Geneformer)")
