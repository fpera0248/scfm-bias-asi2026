...
Changes vs step2a_age_embed_geneformer.py:
  ...
  [ETH 3]  DATASETS -> ethnicity filenames (2143Each, 48Each, Proportional_2497)
...
OUTPUT_BASE = "ILD_Ethnicity_Pilot"  # [ETH 2]
RAW_COUNTS_PATH = BASE / "InterstitialLungDisease_RawCounts_ETHNICITY.h5ad"
...
DATASETS = {
    "Proportional_2497": (
        ...
        f"{OUTPUT_BASE}_Proportional_2497_ETHNICITY_geneformer.h5ad",
    ),
    ...
    "BalancedAugmented_2143Each": (
        ...
        f"{OUTPUT_BASE}_BalancedAugmented_2143Each_ETHNICITY_geneformer.h5ad",
    ),
    "BalancedUpsampled_2143Each": (
        f"{OUTPUT_BASE}_BalancedUpsampled_2143Each_ETHNICITY.h5ad",
        f"{OUTPUT_BASE}_BalancedUpsampled_2143Each_ETHNICITY_geneformer.h5ad",
    ),
    "Downsampled_48Each": (
        f"{OUTPUT_BASE}_Downsampled_48Each_ETHNICITY.h5ad",
        f"{OUTPUT_BASE}_Downsampled_48Each_ETHNICITY_geneformer.h5ad",
    ),
}
