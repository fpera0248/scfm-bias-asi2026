#!/usr/bin/env python3
"""
STEP 3b — kNN Disease Label Propagation (ETHNICITY, Geneformer V2-316M)
...
DATASETS = {                                                     # [GF 3]
    "BalancedAugmented_2143Each": BASE / f"{OUTPUT_BASE}_BalancedAugmented_2143Each_ETHNICITY_geneformer.h5ad",
    "Proportional_2497":          BASE / f"{OUTPUT_BASE}_Proportional_2497_ETHNICITY_geneformer.h5ad",
    "BalancedUpsampled_2143Each": BASE / f"{OUTPUT_BASE}_BalancedUpsampled_2143Each_ETHNICITY_geneformer.h5ad",
    "Downsampled_48Each":         BASE / f"{OUTPUT_BASE}_Downsampled_48Each_ETHNICITY_geneformer.h5ad",
}
...
def main():
    ...
    log("=" * 70)
    log("STEP 3b -- kNN Disease Label Propagation (ETHNICITY, Geneformer)")
    log("=" * 70)
    log(f"KNN_K       = {KNN_K}")
    ...
    log(f"\n{'='*70}")
    log("STEP 3b COMPLETE (ETHNICITY, Geneformer)")
