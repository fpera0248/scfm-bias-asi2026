...
those cells in the step 0a raw counts file (InterstitialLungDisease_RawCounts_ETHNICITY.h5ad)
...
RAW_FILE = BASE / "InterstitialLungDisease_RawCounts_ETHNICITY.h5ad"

# Pilot files — used only to get which cell obs_names belong to each strategy
DATASETS = {
    "Proportional": BASE / "ILD_Ethnicity_Pilot_Proportional_2498_ETHNICITY.h5ad",
    "Augmented":    BASE / "ILD_Ethnicity_Pilot_BalancedAugmented_2091Each_ETHNICITY.h5ad",
    "Upsampled":    BASE / "ILD_Ethnicity_Pilot_BalancedUpsampled_2091Each_ETHNICITY.h5ad",
    "Downsampled":  BASE / "ILD_Ethnicity_Pilot_Downsampled_16Each_ETHNICITY.h5ad",
}
