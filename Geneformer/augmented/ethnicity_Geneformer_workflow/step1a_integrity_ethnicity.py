...
Datasets checked:
    ...
    4. Proportional_2497            — real-only, proportional ethnicity ratio (~2.5k pilot)
    5. BalancedAugmented_2143Each   — same as Full (convenience copy)
    6. BalancedUpsampled_2143Each   — real-only, minorities upsampled to match majority
    7. Downsampled_48Each           — real-only, all groups downsampled to minority size
...
DATASETS = {
    ...
    "Proportional_2497":              f"{OUTPUT_BASE}_Proportional_2497_ETHNICITY.h5ad",
    "BalancedAugmented_2143Each":     f"{OUTPUT_BASE}_BalancedAugmented_2143Each_ETHNICITY.h5ad",
    "BalancedUpsampled_2143Each":     f"{OUTPUT_BASE}_BalancedUpsampled_2143Each_ETHNICITY.h5ad",
    "Downsampled_48Each":             f"{OUTPUT_BASE}_Downsampled_48Each_ETHNICITY.h5ad",
}
