...
DATASETS = {
    "BalancedAugmented_747Each": BASE / f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE_geneformer.h5ad",
    "Proportional_2498":          BASE / f"{OUTPUT_BASE}_Proportional_2498_AGE_geneformer.h5ad",
    "BalancedUpsampled_747Each": BASE / f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE_geneformer.h5ad",
    "Downsampled_230Each":         BASE / f"{OUTPUT_BASE}_Downsampled_230Each_AGE_geneformer.h5ad",
}
