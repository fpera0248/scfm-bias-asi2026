...
sce_ref        <- zellkonverter::readH5AD(
  paste0(OUTPUT_BASE, "_Proportional_2498_AGE.h5ad"), use_hdf5 = TRUE
)
...
zellkonverter::writeH5AD(
  ...
  paste0(OUTPUT_BASE, "_BalancedAugmented_747Each_AGE.h5ad"),
  compression = "gzip"
)
...
zellkonverter::writeH5AD(
  ...
  paste0(OUTPUT_BASE, "_BalancedUpsampled_747Each_AGE.h5ad"),
  compression = "gzip"
)
