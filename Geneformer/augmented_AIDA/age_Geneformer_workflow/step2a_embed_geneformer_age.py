...
BASE         = pathlib.Path("/oscar/home/fperalta/data/fperalta/Geneformer/augmented_AIDA/age_Geneformer_workflow")
...
RAW_COUNTS_PATH  = BASE / "AIDA_RawCounts_AGE.h5ad"

DATASETS = {
    "Proportional_2498": (
        f"{OUTPUT_BASE}_Proportional_2498_AGE.h5ad",
        f"{OUTPUT_BASE}_Proportional_2498_AGE_geneformer.h5ad",
    ),
    "BalancedAugmented_747Each": (
        f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE.h5ad",
        f"{OUTPUT_BASE}_BalancedAugmented_747Each_AGE_geneformer.h5ad",
    ),
    "BalancedUpsampled_747Each": (
        f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE.h5ad",
        f"{OUTPUT_BASE}_BalancedUpsampled_747Each_AGE_geneformer.h5ad",
    ),
    "Downsampled_230Each": (
        f"{OUTPUT_BASE}_Downsampled_230Each_AGE.h5ad",
        f"{OUTPUT_BASE}_Downsampled_230Each_AGE_geneformer.h5ad",
    ),
    "ExternalValidation_10000": (
        "AIDA_Age_External_Validation_10000.h5ad",
        "AIDA_Age_External_Validation_10000_geneformer.h5ad",
    ),
}
