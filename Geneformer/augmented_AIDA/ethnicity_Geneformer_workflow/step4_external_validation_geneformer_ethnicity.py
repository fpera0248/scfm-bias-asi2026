...
Changes vs step4 scFoundation ethnicity:
  ...
  [GF 4]  VALIDATION_FILE -> AIDA_Ethnicity_External_Validation_12500_geneformer.h5ad
...
VALIDATION_FILE = BASE / "AIDA_Ethnicity_External_Validation_12500_geneformer.h5ad"   # [GF 4]
...
def main():
    ...
    log("=" * 70)
    log("STEP 4 -- External Validation Classification (ETHNICITY, Geneformer)")
    log("=" * 70)
    ...
    log(f"\n{'='*70}")
    log(f"STEP 4 COMPLETE (ETHNICITY, Geneformer)")
