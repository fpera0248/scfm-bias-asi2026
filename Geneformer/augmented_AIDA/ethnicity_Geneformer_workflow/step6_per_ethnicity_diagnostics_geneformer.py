#!/usr/bin/env python3
"""
STEP 6 — Per-Ethnicity Fairness Diagnostics (ETHNICITY, Geneformer V2-316M)
...
def main():
    log("=" * 70)
    log("STEP 6 -- Per-Ethnicity Fairness Diagnostics (ETHNICITY, Geneformer)")
    log("=" * 70)
    ...
    lines = [
        "STEP 6 -- PER-ETHNICITY FAIRNESS DIAGNOSTICS (ETHNICITY, Geneformer)",
        "=" * 70, "",
