...
Changes vs scFoundation version:
  ...
  [GF 5] Reference baseline: Proportional_2500
"""
...
FILES = {
    "Proportional_2500":          LABELED_DIR / f"{OUTPUT_BASE}_Proportional_2500_ETHNICITY_geneformer.h5ad",
    "BalancedAugmented_779Each": LABELED_DIR / f"{OUTPUT_BASE}_BalancedAugmented_779Each_ETHNICITY_geneformer.h5ad",
    "BalancedUpsampled_779Each": LABELED_DIR / f"{OUTPUT_BASE}_BalancedUpsampled_779Each_ETHNICITY_geneformer.h5ad",
    "Downsampled_92Each":         LABELED_DIR / f"{OUTPUT_BASE}_Downsampled_92Each_ETHNICITY_geneformer.h5ad",
}
...
def main():
    ...
    if "Proportional_2500" not in datasets:
        raise RuntimeError("Proportional_2500 dataset required as reference baseline.")
    ...
    lines = [
        ...
        "",
        "=" * 70,
        "DELTA SUMMARY (vs Proportional_2500 baseline)",
        "=" * 70,
    ]
