...
Changes vs step3d scFoundation ethnicity:
  ...
  [GF 3]  OUT_FILE  -> AIDA_Ethnicity_External_Validation_12500_geneformer.h5ad
...
AIDA_Ethnicity_External_Validation_12500.h5ad already exists from step0c.
...
IN_FILE  = BASE / "AIDA_Ethnicity_External_Validation_12500.h5ad"
OUT_FILE = BASE / "AIDA_Ethnicity_External_Validation_12500_geneformer.h5ad"   # [GF 3]
...
if not IN_FILE.exists():
    ...
    print(f"AIDA_Ethnicity_External_Validation_12500.h5ad should exist from step0c.", flush=True)
    sys.exit(1)
