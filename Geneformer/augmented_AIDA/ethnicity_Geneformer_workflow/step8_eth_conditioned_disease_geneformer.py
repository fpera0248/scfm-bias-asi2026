#!/usr/bin/env python3
"""
STEP 8 — Ethnicity-Conditioned Disease Prediction (ETHNICITY, Geneformer V2-316M)
...
def main():
    log("=" * 70)
    log("STEP 8 -- Ethnicity-Conditioned Disease Prediction (ETHNICITY, Geneformer)")
    log("=" * 70)
    ...
    lines = [
        "STEP 8 -- ETHNICITY-CONDITIONED DISEASE PREDICTION (ETHNICITY, Geneformer)",
        "=" * 70, "",
        f"Most under-represented group: {UNDERREP_GROUP}",
        "Metrics: accuracy, balanced_accuracy, macro_f1 on 20% held-out test set",
        "Delta = metric(strategy) - metric(Proportional_2500 baseline)",
        "",
        "=" * 70,
