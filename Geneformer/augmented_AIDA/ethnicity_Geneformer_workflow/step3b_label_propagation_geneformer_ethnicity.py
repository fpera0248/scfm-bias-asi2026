...
DATASETS = {                                                     # [GF 3]
    "BalancedAugmented_779Each": BASE / f"{OUTPUT_BASE}_BalancedAugmented_779Each_ETHNICITY_geneformer.h5ad",
    "Proportional_2500":          BASE / f"{OUTPUT_BASE}_Proportional_2500_ETHNICITY_geneformer.h5ad",
    "BalancedUpsampled_779Each": BASE / f"{OUTPUT_BASE}_BalancedUpsampled_779Each_ETHNICITY_geneformer.h5ad",
    "Downsampled_92Each":         BASE / f"{OUTPUT_BASE}_Downsampled_92Each_ETHNICITY_geneformer.h5ad",
}
