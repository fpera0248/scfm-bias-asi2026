...
DATASETS = {
    "BalancedAugmented_650Each": BASE / f"{OUTPUT_BASE}_BalancedAugmented_650Each_AGE_geneformer.h5ad",
    "Proportional_2498":          BASE / f"{OUTPUT_BASE}_Proportional_2498_AGE_geneformer.h5ad",
    "BalancedUpsampled_650Each": BASE / f"{OUTPUT_BASE}_BalancedUpsampled_650Each_AGE_geneformer.h5ad",
    "Downsampled_124Each":         BASE / f"{OUTPUT_BASE}_Downsampled_124Each_AGE_geneformer.h5ad",
}
...
def main():
    ...
    log("=" * 70)
    log("STEP 3b -- kNN Disease Label Propagation (CRC AGE, Geneformer)")
    log("=" * 70)
    log(f"KNN_K      = {KNN_K}")
    ...
    log(f"\n{'='*70}")
    log("STEP 3b COMPLETE (CRC AGE, Geneformer)")
