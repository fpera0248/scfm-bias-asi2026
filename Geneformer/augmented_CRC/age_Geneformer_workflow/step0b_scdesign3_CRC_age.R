#!/usr/bin/env Rscript
# ============================================================
# STEP 0B: AGE AUGMENTATION WITH scDesign3 (CRC PILOT)
# Geneformer workflow — augmented_CRC/age_Geneformer_workflow
# ============================================================
# Based on ILD sex v5. CRC changes:
#   [CRC 1] INPUT/VALIDATION: ColorectalCancer_RawCounts_AGE.h5ad
...
INPUT_H5AD      <- "ColorectalCancer_RawCounts_AGE.h5ad"
VALIDATION_H5AD <- "CRC_Age_External_Validation_9402.h5ad"
OUTPUT_BASE     <- "CRC_Age_Pilot"
CKPTDIR         <- "checkpoints_CRC_age_augmentation_pilot"
LOGFILE         <- "augmentation_CRC_age_pilot_log.txt"
SUFFIX          <- "AGE"
...
VALID_BIN_VALUES <- c("30_39", "40_49", "50_59", "60_69", "70_79")
