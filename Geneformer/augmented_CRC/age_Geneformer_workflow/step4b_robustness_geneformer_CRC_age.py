#!/usr/bin/env python3
"""
STEP 4b — Robustness Stress Test (CRC AGE, Pilot)
...
logger.info("========== STEP 4b START (CRC AGE, Geneformer) ==========")
...
KNOWN_GROUPS = ["30_39", "40_49", "50_59", "60_69", "70_79"]  # [AGE 5]
...
logger.info("========== STEP 4b COMPLETE (CRC AGE, Geneformer) ==========")
