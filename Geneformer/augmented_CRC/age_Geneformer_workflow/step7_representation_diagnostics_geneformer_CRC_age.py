...
OUTDIR      = BASE / "step7_representation_diagnostics_age_geneformer"   # [AGE 1]
...
def main():
    log("=" * 70)
    log("STEP 7 -- Representation Quality & Fairness Diagnostics (CRC AGE, Geneformer)")
    log("=" * 70)
    ...
    out_txt = OUTDIR / "step7_summary_age_geneformer.txt"
    lines = [
        "STEP 7 -- REPRESENTATION QUALITY & FAIRNESS DIAGNOSTICS (CRC AGE, Geneformer)",
        "=" * 70, "",
