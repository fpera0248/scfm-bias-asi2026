#!/usr/bin/env python3
"""STEP 3a — scIB Benchmarking (CRC AGE, Geneformer)"""
import scanpy as sc
import pandas as pd
import numpy as np
import pathlib, time
...
DATASETS = {
    "Proportional_2498":          f"{OUTPUT_BASE}_Proportional_2498_AGE_geneformer.h5ad",
    "BalancedAugmented_650Each": f"{OUTPUT_BASE}_BalancedAugmented_650Each_AGE_geneformer.h5ad",
    "BalancedUpsampled_650Each": f"{OUTPUT_BASE}_BalancedUpsampled_650Each_AGE_geneformer.h5ad",
    "Downsampled_124Each":         f"{OUTPUT_BASE}_Downsampled_124Each_AGE_geneformer.h5ad",
}
