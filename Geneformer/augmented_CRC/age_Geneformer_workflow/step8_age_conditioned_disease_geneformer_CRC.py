#!/usr/bin/env python3
"""
STEP 8 — Age-Conditioned Disease Prediction (AGE, Geneformer V2-316M)
...
OUTDIR      = BASE / "step8_age_conditioned_disease_geneformer"   # [AGE 6]
...
def main():
    log("=" * 70)
    log("STEP 8 -- Age-Conditioned Disease Prediction (CRC AGE, Geneformer)")  # [AGE]
    log("=" * 70)
    ...
    out_worst = OUTDIR / "step8_worst_age_bin_summary_geneformer.csv"
    ...
    out_txt = OUTDIR / "step8_summary_age_geneformer.txt"
    lines = [
        "STEP 8 -- AGE-CONDITIONED DISEASE PREDICTION (CRC AGE, Geneformer)",
        "=" * 70, "",
