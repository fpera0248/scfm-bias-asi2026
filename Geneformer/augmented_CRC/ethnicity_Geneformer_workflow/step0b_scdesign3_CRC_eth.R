#!/usr/bin/env Rscript
# ============================================================
# STEP 0B: ETHNICITY AUGMENTATION WITH scDesign3 (CRC PILOT)
# Geneformer workflow — augmented_CRC/ethnicity_Geneformer_workflow
# ============================================================
# Based on ILD sex v5. CRC changes:
#   [CRC 1] INPUT/VALIDATION: ColorectalCancer_RawCounts_ETH.h5ad
...
CKPTDIR         <- "checkpoints_CRC_eth_augmentation_pilot"
LOGFILE         <- "augmentation_CRC_eth_pilot_log.txt"
SUFFIX          <- "ETH"
...
VALID_BIN_VALUES <- c("european american", "hispanic or latin", "asian", "african american")
...
SECONDARY_COVARIATES  <- c("sex", AGE_BIN_COL)

COPY_DIRS <- c(
  "/oscar/home/fperalta/data/fperalta/scGPT/augmented_CRC/ethnicity_scGPT_workflow",
  "/oscar/home/fperalta/data/fperalta/scfoundation/augmented_CRC/ethnicity_scfoundation_workflow"
)
